import { SlidingLogoMarqueeItem, SlidingLogoMarquee } from '../lightswind/sliding-logo-marquee';
...
const originalLogos: SlidingLogoMarqueeItem[] = [
  {
    id: "1",
    ...
    content: <img src={shopping} alt="Amazon" className="h-34 w-auto object-contain mx-8 " />
  },
  {
    id: "2",
    content: <img src={shopping} alt="Amazon" className="h-34 w-auto object-contain mx-8" />
...
const logos = [...originalLogos, ...originalLogos, ...originalLogos, ...originalLogos, ...originalLogos].map((item, index) => ({
  ...item,
